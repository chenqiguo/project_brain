...
#import utils_myTest2
from data_utils.ModelNetDataLoader_v2 import ModelNetDataLoader
#from model_custom_rowSizeKernel_v1 import Model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--tolerance', default=0.2, type=float, help='tolerance of difference between abs(gt-pred)') # 2 for target_list_orig
    parser.add_argument('--result_rootDir', default='/eecf/cbcsl/data100b/Chenqi/project_brain/col_row_size_kernel_resnet/results_customModel/', type=str, help='Root dir of the results')
