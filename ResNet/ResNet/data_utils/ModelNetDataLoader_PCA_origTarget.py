...
from data_utils.loadMatFile_PCA_origTarget import loadTargetMatFile
...
class ModelNetDataLoader(Dataset):
    def __init__(self, root, args, split='train'): # , process_data=False
        ...
        self.new_featDim = args.new_featDim
    ...
    def _get_item(self, index):
        ...
        connData_feat, target = loadTargetMatFile(self.label_name, target_mat_fullname, self.new_featDim) # PCA version 1
        ...
        return connData_feat, target, target_mat_fullname # torch.Size([B, 64984, 379]), torch.Size([B])
...
if __name__ == '__main__': # just for debug
    ...
    for point, label, _ in DataLoader:
        print(point.shape) # torch.Size([1, 64984, 50])
