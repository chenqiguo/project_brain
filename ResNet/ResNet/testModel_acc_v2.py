...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='results_myTest3/best_1_50_model.pth',help='The pretrained model path')
    ...
    parser.add_argument('--result_dir', default='results_myTest3/acc_v2.txt', type=str, help='Dir to save the acc result')
    parser.add_argument('--tolerance', default=0.2, type=float, help='tolerance of difference between abs(gt-pred)')
