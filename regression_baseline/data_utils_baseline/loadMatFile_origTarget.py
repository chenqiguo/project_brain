...
def loadTargetMatFile_PCA(data_dir, target_behavior_name, target_mat_name):
    # e.g., data_dir = '/eecf/cbcsl/data100b/Chenqi/project_brain/connData_dimReduc/results/PCA_v3/connData_dimReduc_PCA_v3.pkl'
