...
from data_utils_PCA.loadMatFile_2PCA_origTarget import loadTargetMatFile_PCA
...
class ModelNetDataLoader_PCA(Dataset):
    ...
    def _get_item(self, index):
        ...
        dataMat_feat, target = loadTargetMatFile_PCA(self.data_dir, self.label_name, target_subjectFileName) # dataMat_feat of dim (32,32)
...
if __name__ == '__main__': # just for debug
    ...
    data = ModelNetDataLoader_PCA(args, split='train')
