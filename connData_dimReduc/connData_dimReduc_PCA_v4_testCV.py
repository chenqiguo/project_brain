...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug  3 19:17:01 2021

@author: guo.1648
"""

# From all the 1018 samples,
# (3) use the 10-fold split in (2) to generate PCA_v4_testCV train&valid set
#     (code similar to that for PCA_v4_CV);
# (4) combine the 900 samples in (2) as whole "training set" to generate eigenVecs,
#     and then project the 118 test set samples in (1) onto the generated eigenVecs.
...
if __name__ == '__main__':
    ...
    folder_list = ['CV0/','CV1/','CV2/','CV3/','CV4/','CV5/','CV6/','CV7/','CV8/','CV9/', 'test_set/']
    
    for folder_name in folder_list:
        print('$$$$$$$$$$$$$$$$$$$$$$$ ' + folder_name + ' $$$$$$$$$$$$$$$$$$$$$$$')
        
        dstDir_CV = dstRootDir + folder_name
        CV_trainValDir = train_valid_root + folder_name
        ...
        for j in range(379): # for each region
            ...
            # eigenVecs_V3.shape: (64984,32); dataMat_E.shape: (810, 32)
            ...
            dataMat_E = np.matmul(dataMat_Dj_valid, eigenVecs_V3) # dim (90, new_featDim)
            # save dataMat_E to tmp file:
        ...
        for k in range(new_featDim): # ie 32: for each new "vertex" feat
            ...
            dataMat_G = np.matmul(dataMat_F, eigenVecs_V4) # dim (90, new_featDim) <-- check shape!!!
            # save dataMat_G to tmp file:
