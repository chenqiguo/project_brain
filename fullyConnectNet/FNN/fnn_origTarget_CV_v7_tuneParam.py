...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 18 16:23:22 2021

@author: guo.1648
"""

# referenced from fnn_origTarget_CV_v6_tuneParam.py:
# here using graph features from /connData_graph/graphFeat/v3_MMPconnSparse/ as input,
# fnn_model_v4 as FNN model, and '..._Raw' as targets.
...
from fnn_model_v4 import hcp_fnn


srcRootDir_sparse = '/eecf/cbcsl/data100b/Chenqi/project_brain/MMPconnSparse/'

srcRootDir = '/eecf/cbcsl/data100b/Chenqi/project_brain/connData_graph/graphFeat/v3_MMPconnSparse/'
...
dstRootDir = '/eecf/cbcsl/data100b/Chenqi/project_brain/fullyConnectNet/FNN/result/fnn_origTarget_CV_v7/'
...
"""
all_target_list = ['DSM_Anxi_Raw', 'ASR_Anxd_Raw', 'DSM_Depr_Raw', 'DSM_Adh_Raw', 'ASR_Attn_Raw',
                   'DSM_Avoid_Raw', 'CogFluidComp_Unadj', 'CogCrystalComp_Unadj', 'CogTotalComp_Unadj',
                   'PMAT24_A_CR', 'PMAT24_A_RTCR', 'VSPLOT_TC', 'VSPLOT_CRTE', 'VSPLOT_OFF',
                   'ER40_CR', 'ER40_CRT', 'SCPT_SEN', 'SCPT_SPEC', 'SCPT_TPRT', 'CardSort_Unadj',
                   'Flanker_Unadj', 'ProcSpeed_Unadj', 'DDisc_AUC_200', 'DDisc_AUC_40K',
                   'PicSeq_Unadj', 'ReadEng_Unadj', 'PicVocab_Unadj', 'IWRD_TOT', 'IWRD_RTC',
...
feat_name = 'degree_centrality' # 'betweenness_centrality'
...
def tune_params_func_newVer7(train_test_root, srcDir, threshold):
...
if __name__ == '__main__':
    ...
    threshold_list = [0.2, 0.1, 0.5, 0.01, 0.05]
    ...
    for threshold in threshold_list:
        ...
        best_params, best_Pearson_r_val = tune_params_func_newVer7(train_test_root, srcDir, threshold)
