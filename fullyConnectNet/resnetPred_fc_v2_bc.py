...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 10 18:16:41 2021
...
# deep fully connected network v2 with flatten 2PCA connData as input.

# referenced from resnetPred_fc_v1_bc.py
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Train Deep FC Binary Classification w. PCA Flatten Data, v1')
    ...
    # training loop:
    max_lr = 0.3 #<- #0.1 #0.05 #0.005 #0.01
    grad_clip = 0.1
    weight_decay = 1e-7
